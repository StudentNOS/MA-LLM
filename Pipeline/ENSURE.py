...
def main(screen_titles, TitlePrompt, screen_abstracts, AbstractPrompt, row_index, Prompts):
    ...
    if screen_titles == 1:
        ...
        for titles_batch in get_data_in_batches("titles"):
            ...
            #BatchForBatches += 1
            #if BatchForBatches > 20:
            #    BatchForBatches = 0
            #    print("Sleeping for 5 min please do something relaxing in order to maintain attention for future tasks.")
            #    time.sleep(300)
